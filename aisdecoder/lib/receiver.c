...
struct receiver *init_receiver(char name, int num_ch, int ch_ofs, int add_sample_num,unsigned long mmsi)
{
	struct receiver *rx;
	...
	protodec_initialize(rx->decoder, NULL, name, add_sample_num,mmsi);
